...
public interface AdminApi {
  ...
  @APIResponses({
      @APIResponse(
          ...
          content = @Content(
              ...
              schema = @Schema(implementation = EnvelopeUserWithSponsorDTO.class)))
  })
  ...
  @APIResponses({
      @APIResponse(
          ...
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeVoid.class)))
  })
  ...
  @APIResponses({
      @APIResponse(
          ...
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeUserWithSponsorListDTO.class)))
  })
  Response listUsers(
  ...
  @APIResponses({
      @APIResponse(
          ...
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeBenefitDTO.class)))
  })
  ...
  @APIResponses({
      @APIResponse(
          ...
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeBenefitListDTO.class)))
  })
  ...
  @APIResponses({
      @APIResponse(
          responseCode = "200",
          description = "Benefício desativado",
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeVoid.class)))
  })
  ...
  @APIResponses({
      @APIResponse(
          responseCode = "200",
          description = "Benefício excluído",
          content = @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema = @Schema(implementation = EnvelopeVoid.class)))
  })
